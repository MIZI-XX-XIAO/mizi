...
def test_maintained_text_files_have_purpose_headers() -> None:
    ...
    expected.update({
        ...
        PROJECT_ROOT / "pyproject.toml": ("# 本文件",),
        PROJECT_ROOT / "README.md": ("<!-- 本文件",),
        PROJECT_ROOT / "requirements.txt": ("# This file was autogenerated by uv",),
        PROJECT_ROOT / "requirements-dev.txt": ("# This file was autogenerated by uv",),
        PROJECT_ROOT / "requirements-build.txt": ("# This file was autogenerated by uv",),
